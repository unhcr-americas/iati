...
#' @export 
#' @return  a graph
show_sectors_rbm <- function(year, 
                         programme_lab = NULL, 
                         iati_identifier_ops = NULL, 
                         ctr_name = NULL ){
  # Check if only one argument is passed 
...
```{r tests-show_sectors_rbm}
test_that("show_sectors_rbm works", {
  expect_true(inherits(show_sectors_rbm, "function")) 
})
```
