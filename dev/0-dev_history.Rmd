...
fusen::fill_description(
  ...
  fields = list(
    ...
    Description = "This is a data package with all frame organised and reshapped for easy consumptions in R Please see https://reporting.unhcr.org/iati",
    `Authors@R` = c(
      person("Edouard", "Legoupil", email = "legoupil@unhcr.org", role = c("aut", "cre"), comment = c(ORCID = " ")),
